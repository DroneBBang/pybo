...
@login_required(login_url='common:login')   #해당함수를 실행하기 위한 전제조건, 로그인 상태
...
def answer_modify(request, answer_id):
    ...
    if request.user != answer.author:
        ...
        return redirect('pybo:detail', question_id=answer.question.id)      #answer에서 가져온거보면 question이라고 foreign key가져온 변수 있음.
